...
void optBundling(std::vector<double>* recievers, std::vector<std::vector<double>>* senders, std::vector<std::vector<double>>* data, std::vector<double>* costPerIteration, std::vector<double>* timePerIteration) {
    Problem problem;
